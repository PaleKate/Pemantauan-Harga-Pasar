<div class="modal fade" id="modal-lg-edit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-full-width modal-dialog-scrollable">
		<div class="modal-content">
				<?php 
						$sql = "SELECT * FROM het WHERE id_het='42fdd66d9a7ba8e267e844c9578c69883fd3a0loe'";
			...
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="het-editact.php">
					<div class="row g-2">
						<div class="mb-3 col-md-3">
							<label class="form-label">Beras Premium (Kg)</label>
								<div class="input-group flex-nowrap">
									<span class="input-group-text" id="basic-addon1">Rp</span>
									<input type="hidden" class="form-control" name="id" value="<?php echo htmlentities($result['id_het']);?>" readonly>
